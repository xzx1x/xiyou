...
VALUES
  ('202202100', 'USER', '示例普通用户账号 202202100'),
  ('202202101', 'USER', '示例普通用户账号 202202101'),
  ('202202102', 'USER', '示例普通用户账号 202202102'),
  ('202202103', 'USER', '示例普通用户账号 202202103'),
  ('202202104', 'USER', '示例普通用户账号 202202104'),
  ('202202105', 'USER', '示例普通用户账号 202202105'),
  ('202202106', 'USER', '示例普通用户账号 202202106'),
  ('202202107', 'USER', '示例普通用户账号 202202107'),
  ('202202108', 'USER', '示例普通用户账号 202202108'),
  ('202202109', 'USER', '示例普通用户账号 202202109'),
  ('123456', 'ADMIN', '示例管理员账号'),
  ('12345678', 'ADMIN', '示例管理员账号 12345678')
